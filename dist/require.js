...
;
  ...
  Polymer({
    ...
    renderFeature : function(feature, i) {
      ...
      if( feature.properties.type == 'Link Group' ) {
        link = '<a>Line Group</a>';
      } else if ( feature.properties.type == 'Region' ) {
        link = '<a class="region" index="'+i+'" style="cusor:pointer">'+feature.properties.name+'</a>';
      } else {
        link = '<a href="#info/'+feature.properties.prmname+'">'+feature.properties.prmname+'</a>';
...
;
  ...
  Polymer({
    ...
    ready : function() {
      this.$.popup.header = 'CALVIN Water Network';
